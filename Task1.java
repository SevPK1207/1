...
class Task1 {
    public static void main(String[] args) {
        boolean t1 = Task1.subtask1();
        System.out.println("1.1 " + t1);
        boolean t2 = Task1.subtask2();
        System.out.println("1.2 " + t2);
        boolean t3 = Task1.subtask3();
        System.out.println("1.3 " + t3);
        boolean t4 = Task1.subtask4();
        System.out.println("1.4 " + t4);
        boolean t5 = Task1.subtask5();
        System.out.println("1.5 " + t5);
        boolean t6 = Task1.subtask6();
        System.out.println("1.6 " + t6);
        boolean t7 = Task1.subtask7();
        System.out.println("1.7 " + t7);
        boolean t8 = Task1.subtask8(new int[]{1, -10, 5, 6, 45, 23, 45, -34, 0, 32,
        56, -1, 2, -2});
        System.out.println("1.8 " + t8);
        boolean t9 = Task1.subtask9(new int[] { 15, 10, 51, 6, 5, 3, 10, -34, 0, 32, 56, 12, 24, 52 });
        System.out.println("1.9 " + t9);
        boolean t10 = Task1.subtask10(new int[] { 15, 10, 0, -6, -5, 3, 0, -34, 0, 32, 56, 0, 24, 52 });
    ...
    private static boolean subtask1() { // объявление метода
        ...
        boolean bNumeric = Task1.isNumeric(str);
        if (!bNumeric) {
            System.out.println("На ввод ожидалось число!!!");
            return Task1.subtask1();
        }
    ...
    private static boolean subtask5() { // объявление метода
        ...
        // проверка что это число
        boolean bNumeric0 = Task1.isNumeric(str0);
        if (!bNumeric0) {
            System.out.println("На ввод ожидалось число!!!");
            return Task1.subtask5();
        }
        // превращаем в число
        ...
        // проверка что это число
        boolean bNumeric1 = Task1.isNumeric(str1);
        if (!bNumeric1) {
            System.out.println("На ввод ожидалось число!!!");
            return Task1.subtask5();
        }
        ...
        // проверка что это число
        boolean bNumeric2 = Task1.isNumeric(str2);
        if (!bNumeric2) {
            System.out.println("На ввод ожидалось число!!!");
            return Task1.subtask5();
        }
